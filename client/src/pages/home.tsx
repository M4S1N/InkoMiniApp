            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className="border border-primary-foreground/20 hover:bg-primary-foreground/10 text-primary-foreground px-8 py-3 rounded-lg font-semibold transition-colors"
